export const data = {
  ...
  // linkedin: "https://www.linkedin.com/in/petronilla",
  // blog: "https://dev.to/petronilla",
  // twitter: "https://twitter.com/kemunto",
  skills: [
    "Nephrology Nursing",
    "Midwifery",
    "Electro-Encephalography",
    "Patient Triaging",
    "Education & awareness on Epilepsy",
  ...
  projects: [
    ...
    {
      title: "Understanding Epilepsy and the brain",
      imageURL: "talkr1.png",
    ...
    {
      title: "Handling myths and beliefs in Epilepsy",
    ...
    {
      title: "Facts and rights about Epilepsy",
    ...
    {
      title: "Epilepsy: treatment and perception",
      imageURL: "cli1.png",
    ...
    {
      title: "Stress: coping with Epilepsy",
      imageURL: "cli1.png",
      description: "Enter symptoms and receive diagnoses from the command line",
      technology: "Ruby • rest-client • Infermedica API",
      // githubURL: "https://github.com/sylviapap/ruby-cli-app"
